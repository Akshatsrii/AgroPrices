...
import { Phone, ArrowRight, Shield, Sparkles, UserCheck } from 'lucide-react';
      ...
      {authMethod === 'clerk' && clerkPubKey ? (
        ...
        <div className="w-full bg-white/95 backdrop-blur-xl border border-emerald-100 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Farmer Mobile Login</h2>
              <p className="text-xs text-gray-500">Enter details to log in to AgroPrice AI</p>
            </div>
          </div>
          ...
          <form onSubmit={handlePhoneSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-bold text-gray-900 focus:bg-white focus:border-emerald-600 outline-none"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="Sehore"
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl px-3 py-2.5 text-xs font-bold text-gray-900 focus:bg-white focus:border-emerald-600 outline-none"
                />
              </div>
              <div>
                <label className="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-1">
            ...
            <div>
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-16 pr-4 py-3.5 text-base font-bold text-gray-900 focus:bg-white focus:border-emerald-600 outline-none"
                />
              </div>
