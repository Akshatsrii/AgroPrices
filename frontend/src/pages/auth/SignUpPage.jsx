      ...
      <SignUp 
        ...
        appearance={{
          elements: {
            ...
            formButtonPrimary: 'w-full bg-black hover:bg-gray-900 text-white font-bold py-3.5 rounded-xl text-sm transition-all shadow-md active:scale-[0.98] cursor-pointer mt-3',
            footerActionText: 'text-sm text-gray-500 font-medium',
            footerActionLink: 'text-orange-600 hover:text-orange-700 font-bold ml-1 no-underline',
            footer: 'bg-transparent border-t border-gray-100 pt-3 mt-3',
            identityPreviewText: 'font-semibold text-gray-800',
            identityPreviewEditButton: 'text-green-600 hover:text-green-700 font-bold text-xs',
          },
          variables: {
            colorPrimary: '#000000',
            colorText: '#0f172a',
